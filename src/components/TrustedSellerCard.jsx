...
export default function TrustedSellerCard({
	...
	return (
		<div
			className={`min-w-[320px] h-64 p-6 bg-white rounded-2xl shadow-xl border-2 flex flex-col gap-4 shrink-0 transition-transform hover:scale-[1.02] ${isMaster ? "border-pink-600" : "border-purple-700/30"}`}
		>
			{/* Profile Header */}
