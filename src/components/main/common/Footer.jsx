		...
		<footer className="w-full bg-gradient-to-r from-violet-800 via-purple-600 to-violet-800 border-t-4 border-pink-600 font-inter">
			...
			<section className="w-full py-5 px-4 text-white">
				<div className="max-w-[1200px] mx-auto text-center">
					...
					<p className="text-purple-100/80 mb-10 text-lg">
			...
			<div className="w-full py-5 px-4 shadow-inner bg-gradient-to-r from-pink-600 via-pink-400 to-pink-600">
				<div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-center gap-4">
					...
					<div className="text-center md:text-left">
						<span className="block text-white font-black text-xl tracking-tighter leading-none">
							NUKE SUITE™ ACTIVE
						</span>
						<span className="text-white/90 text-sm font-bold uppercase tracking-tighter">
					...
					<div className="flex flex-wrap justify-center gap-12 md:gap-24 my-5">
						{securityIcons.map((item) => (
							...
							>
								...
								<span className="font-black text-sm tracking-widest text-pink-100">
									{item.label}
								</span>
							</div>
						))}
