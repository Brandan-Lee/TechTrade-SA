...
const ActiveListingCard = ({ title, price, condition, time, views, img }) => (
	<div className="w-full p-4 bg-gradient-to-r from-violet-800 via-purple-600 to-violet-800 rounded-xl border border-pink-600 flex gap-4 transition-transform hover:scale-[1.02] cursor-pointer">
		<img
			src={img}
			alt="title"
