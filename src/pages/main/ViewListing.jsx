		...
		<div className="min-h-screen bg-gray-50 pb-20 font-['Inter']">
			<main className="max-w-6xl mx-auto px-4 pt-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
				...
				<div className="lg:col-span-7 flex flex-col gap-6">
					...
					<div className="flex flex-col gap-3">
						<div className="aspect-square w-full bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200 relative group">
							...
							<div className="absolute top-4 right-4 bg-black/50 backdrop-blur-md px-3 py-1 rounded-full text-white text-sm md:text-base font-black tracking-widest z-10">
					...
					<div className="bg-gradient-to-r from-violet-800 via-purple-600 to-violet-800 rounded-xl p-6 shadow-xl border border-pink-600/30 text-white">
						...
						<div className="flex gap-6 mb-6 text-white/60">
							<div className="flex items-center gap-1.5 text-xs md:text-base font-bold uppercase tracking-tighter">
								<Eye size={14} className="text-white" /> 143 views
							</div>
							<div className="flex items-center gap-1.5 text-xs md:text-sm font-bold uppercase tracking-tighter">
								<Clock size={14} className="text-white" /> Posted 2 days ago
							</div>
						</div>
						...
						<div className="space-y-4 border-t border-white/10 pt-6">
							...
							<p className="text-white/80 leading-relaxed text-sm md:text-base font-medium italic">
								...
								climate-controlled environment. Never overclocked. Perfect for
								4K gaming.
							</p>
						</div>
					</div>
					...
					<div className="bg-gradient-to-r from-violet-800 via-purple-600 to-violet-800 rounded-xl p-6 shadow-xl text-white">
						...
						<div className="grid grid-cols-1 gap-1">
							{specs.map((spec, idx) => (
								<div
									key={idx}
									className="flex justify-between items-center py-3 border-b border-pink-600 last:border-0 hover:bg-white/5 transition-colors px-2 rounded"
								>
				...
				<div className="lg:col-span-5 flex flex-col gap-6">
					...
					<div className="bg-gradient-to-r from-pink-600 via-pink-400 to-pink-600 rounded-xl p-6 shadow-xl border border-purple-700/20 text-white">
						...
						<div className="grid grid-cols-3 gap-2 text-center bg-black/10 rounded-xl py-4 border border-white/10 mt-6">
							<div>
								...
								<p className="text-[9px] font-black uppercase opacity-70 tracking-widest mt-1">
									Trust Score
								</p>
							</div>
							<div>
					...
					<div className="bg-gradient-to-r from-pink-600 via-pink-400 to-pink-600 rounded-xl p-6 shadow-xl border border-pink-600/30 text-white">
						...
						<div className="flex flex-col gap-3">
							<div className="relative">
								<span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-black text-lg z-10">
									R
								</span>
								<AuthInput
									type="number"
							...
							<label className="text-white text-base font-black uppercase tracking-[0.2em] ml-1">
								Buyers Note
							</label>
							<textarea
							...
							<PurpleGradientButton label="SUBMIT OFFER" />
						</div>
					</div>
					...
					{/* Similar Listings */}
					<div onClick={handleViewListing} className="flex flex-col gap-4 mt-4">
